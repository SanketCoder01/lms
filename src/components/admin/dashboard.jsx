...
const Dashboard = () => {
    ...
    // Added realtime syncing for fetching lease stats
    useEffect(() => {
        const channel = supabase.channel('lease-dashboard-stats-channel')
        ...
        <div className="dashboard-container">
            ...
            <main className="main-content">
                ...
                <div style={{ marginTop: '40px', paddingTop: '30px', borderTop: '2px solid #e2e8f0' }}>
                    <h2 style={{ margin: '0 0 20px', fontSize: '1.25rem', fontWeight: '700', color: '#64748b' }}>
                ...
                </div>{/* End of old dashboard wrapper */}
            </main>
        </div>
    );
};
