        ...
        <>
            ...
            <div className={`sidebar ${isOpen ? 'open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    {/* 4. Unit Structure */}
                    <NavLink to="/admin/unit-structure" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={() => setIsOpen(false)}>
                        <span className="icon">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="5" rx="1" /><rect x="2" y="10" width="20" height="5" rx="1" /><rect x="2" y="17" width="20" height="5" rx="1" /></svg>
                        </span>
                        Unit Structure
                    </NavLink>
